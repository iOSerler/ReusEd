    ...
    var body: some View {
        VStack(alignment: .center) {
            ...
            Button(action: {
                ...
                for i in question1SelectedItemsIdx {
                    question1Answers.append(question1.optionsData[i].secondPart)
                }
                for i in question2SelectedItemsIdx {
                    question2Answers.append(question2.optionsData[i].secondPart)
                }
