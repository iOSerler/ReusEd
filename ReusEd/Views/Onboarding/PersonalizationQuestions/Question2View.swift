...
struct Question2View: View {
    ...
    var body: some View {
        VStack(alignment: .center, spacing: UIScreen.main.bounds.width/15) {
            ...
            List {
                ForEach(question2.optionsData.indices, id: \.self) { index in
                    RowView(
                        id: question2.optionsData.firstIndex(of: question2.optionsData[index])!,
                        firstPart: question2.optionsData[index].firstPart,
                        secondPart: question2.optionsData[index].secondPart,
                        tapped: question2SelectedItemsBool[index],
                        questionId: 2
                    )
                        .padding()
