            ...
            Image(question3.stepsImage)
                .onAppear(){
                    if let temp =  UserDefaults.standard.value(forKey:"question3SelectedIdx") {
                        self.selectedIndex = temp as! Int
                    }
                }
            ...
            Button(action: {
                ...
                HStack {
                    ...
                    Text(question3.optionsData[0].secondPart)
                        ...
                        .foregroundColor(self.selectedIndex == 1 ? Color(question3.optionsColor) : Color(question3.descriptionColor))
                        .padding(.trailing, 20)
            ...
            Button(action: {
                ...
                HStack {
                    ...
                    Text(question3.optionsData[1].secondPart)
                        .font(.custom(question3.descriptionFont, size: 14))
                        .foregroundColor(self.selectedIndex == 2 ? Color(question3.optionsColor) : Color(question3.descriptionColor))
                        .padding(.trailing, 20)
            ...
            Button(action: {
                ...
                HStack {
                    ...
                    Text(question3.optionsData[2].secondPart)
                        .font(.custom(question3.descriptionFont, size: 14))
                        .foregroundColor(self.selectedIndex == 3 ? Color(question3.optionsColor) : Color(question3.descriptionColor))
                        .padding(.trailing, 20)
            ...
            Button(action: {
                ...
                HStack {
                    ...
                    Text(question3.optionsData[3].secondPart)
                        .font(.custom(question3.descriptionFont, size: 14))
                        .foregroundColor(self.selectedIndex == 4 ? Color(question3.optionsColor) : Color(question3.descriptionColor))
                        .padding(.trailing, 20)
